...
module.exports = function(app, mongoose,db){
    ...
    var questionModel = require("./models/question.model.server.js")(app, db, mongoose, userModel);
    ...
    var commentsModel = require("./models/comments.model.server.js")(app, db, mongoose, petModel, userModel);
